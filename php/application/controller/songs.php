...
class Songs extends Controller
{
    ...
    public function index()
    {
        ...
        $trainings = $this->model->getAllTraining();
        $amount_of_songs = $this->model->getAmountOfSongs();
        $amount_of_training = $this->model->getAmountOfTraining();
    ...
    {
        // if we have POST data to create a new song entry
        if (isset($_POST["submit_add_training"])) {
            // do addSong() in model/model.php
            $this->model->addTraining($_POST["xml"], $_POST["distance"], $_POST["t_time"],  $_POST["calories"]);
        }
    ...
    public function deleteTraining($training_id)
    {
        ...
        if (isset($training_id)) {
            // do deleteSong() in model/model.php
            $this->model->deleteTraining($training_id);
        }
    ...
    public function editTraining($training_id)
    {
        ...
        if (isset($training_id)) {
            // do getSong() in model/model.php
            $song = $this->model->getTraining($training_id);
    ...
    {
        // if we have POST data to create a new song entry
        if (isset($_POST["submit_update_training"])) {
            // do updateSong() from model/model.php
            $this->model->updateTraining($_POST["distance"], $_POST["t_time"],  $_POST["calories"], $_POST['training_id']);
        }
